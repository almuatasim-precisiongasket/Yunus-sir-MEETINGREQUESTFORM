        ...
        >
          ...
          <div className="mb-xl border-b border-slate-100 pb-lg relative text-center w-full block">
            <div className="space-y-2.5 max-w-2xl mx-auto text-center block w-full">
              ...
              <h1 className="w-full block font-sans text-2xl md:text-3xl font-black text-[#0B1F33] tracking-tight">
                <EncryptedText 
                  text={template.title} 
              ...
              <p className="w-full block font-sans text-xs md:text-sm text-slate-500 leading-relaxed font-medium mx-auto max-w-xl">
                <EncryptedText 
