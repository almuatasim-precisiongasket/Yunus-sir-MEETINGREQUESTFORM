      ...
      <div className="bg-[#0B1F33] min-h-screen flex flex-col justify-center items-center p-4 text-[#111827] antialiased">
        ...
        >
          ...
          <form onSubmit={handleLoginSubmit} className="space-y-4">
            ...
            <button type="submit" className="w-full py-3.5 bg-[#008FD5] text-white hover:bg-[#008FD5]/90 active:scale-[0.98] rounded-xl font-semibold text-xs shadow-md transition-all cursor-pointer">
              Log Into PRECI FORM
            </button>
